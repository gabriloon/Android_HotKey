...
public class TouchpadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button left = findViewById(R.id.mouse_left);
        Button right = findViewById(R.id.mouse_right);
        View view = findViewById(R.id.mouse_view);
        Button soundUp = findViewById(R.id.mouse_activity_sound_up);
        Button soundDown = findViewById(R.id.mouse_activity_sound_down);
        Button moveLeft = findViewById(R.id.mouse_move_left);
        Button moveRight = findViewById(R.id.mouse_move_right);
        Button pull = findViewById(R.id.mouse_move_full);
